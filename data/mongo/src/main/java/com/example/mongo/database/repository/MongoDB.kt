...
package com.example.mongo.database.repository
...
object MongoDB : MongoRepository {
    ...
    override fun getAllDiaries(): Flow<Diaries> {
        return if (user != null) {
            ...
            flow { emit(RequestState.Error(com.example.mongo.database.repository.UserNotAuthenticatedException())) }
        }
    }
    ...
    override suspend fun insertDiary(diary: Diary): RequestState<Diary> {
        return if (user != null) {
            ...
            RequestState.Error(com.example.mongo.database.repository.UserNotAuthenticatedException())
        }
    }
